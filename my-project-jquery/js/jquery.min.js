...
(function (e, t) {
  var n, r, i = typeof t, o = e.location, a = e.document, s = a.documentElement, l = e.jQuery, u = e.$, c = {}, p = [],
    f = "1.10.0", d = p.concat, h = p.push, g = p.slice, m = p.indexOf, y = c.toString, v = c.hasOwnProperty,
...
(function (t, i) {
  ...
  e.fn || (e.fn = function (i, n) {
    var s = arguments, o = i.match(/^([a-z\-]+)(?:\.([a-z]+))?/i), a = o[1], r = o[2];
    return e[a] ? this.each(function () {
      var i = t(this), o = i.data(a);
      o || i.data(a, o = new e[a](this, r ? void 0 : n)), r && o[r].apply(o, Array.prototype.slice.call(s, 1))
    }) : (t.error("UIkit component [" + a + "] does not exist."), this)
  }, e.support = {}, e.support.transition = function () {
    var t = function () {
      var t, e = i.body || i.documentElement, n = {
    ...
    return t && {end: t}
  }(), e.support.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch, e.Utils = {}, e.Utils.debounce = function (t, i, e) {
    var n;
    return function () {
      var s = this, o = arguments, a = function () {
        n = null, e || t.apply(s, o)
      }, r = e && !n;
      clearTimeout(n), n = setTimeout(a, i), r && t.apply(s, o)
    }
  ...
  function e(t, i, e, n) {
    var s = Math.abs(t - i), o = Math.abs(e - n);
  ...
  t(document).ready(function () {
    ...
    t(document.body).bind("touchstart", function (e) {
      d = Date.now(), p = d - (h.last || d), h.el = t(i(e.originalEvent.touches[0].target)), a && clearTimeout(a), h.x1 = e.originalEvent.touches[0].pageX, h.y1 = e.originalEvent.touches[0].pageY, p > 0 && 250 >= p && (h.isDoubleTap = !0), h.last = d, u = setTimeout(n, c)
    }).bind("touchmove", function (t) {
      s(), h.x2 = t.originalEvent.touches[0].pageX, h.y2 = t.originalEvent.touches[0].pageY
    }).bind("touchend", function () {
      s(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? l = setTimeout(function () {
  ...
  var e = function (i, e) {
    var n = this;
    this.options = t.extend({}, this.options, e), this.element = t(i).on("click", this.options.trigger, function (t) {
      t.preventDefault(), n.close()
    })
  };
  t.extend(e.prototype, {
    options: {fade: !0, duration: 200, trigger: ".uk-alert-close"}, close: function () {
      function t() {
  ...
  }), i.alert = e, t(document).on("click.alert.uikit", "[data-uk-alert]", function (n) {
    var s = t(this);
  ...
  var e = function (i, e) {
    var n = this, s = t(i);
    this.options = t.extend({}, this.options, e), this.element = s.on("click", this.options.target, function (i) {
      i.preventDefault(), s.find(n.options.target).not(this).removeClass("uk-active").blur(), s.trigger("change", [t(this).addClass("uk-active")])
    })
  };
  t.extend(e.prototype, {
    options: {target: ".uk-button"}, getSelected: function () {
      this.element.find(".uk-active")
    }
  });
  var n = function (i, e) {
    var n = t(i);
    this.options = t.extend({}, this.options, e), this.element = n.on("click", this.options.target, function (i) {
      i.preventDefault(), n.trigger("change", [t(this).toggleClass("uk-active").blur()])
    })
  };
  ...
  var s = function (i) {
    var e = this;
    this.element = t(i).on("click", function (t) {
      t.preventDefault(), e.toggle(), e.element.blur()
    })
  };
  ...
  }), i.button = s, i["button-checkbox"] = n, i["button-radio"] = e, t(document).on("click.button-radio.uikit", "[data-uk-button-radio]", function (n) {
    var s = t(this);
  ...
  }), t(document).on("click.button-checkbox.uikit", "[data-uk-button-checkbox]", function (e) {
    var s = t(this);
  ...
  "use strict";
  var e = !1, n = function (i, n) {
    var s = this;
    this.options = t.extend({}, this.options, n), this.element = t(i), this.dropdown = this.element.find(".uk-dropdown"), this.centered = this.dropdown.hasClass("uk-dropdown-center"), this.justified = this.options.justify ? t(this.options.justify) : !1, this.boundary = t(this.options.boundary), this.boundary.length || (this.boundary = t(window)), "click" == this.options.mode ? this.element.on("click", function (i) {
      t(i.target).parents(".uk-dropdown").length || i.preventDefault(), e && e[0] != s.element[0] && e.removeClass("uk-open"), s.element.hasClass("uk-open") ? (t(i.target).is("a") || !s.element.find(".uk-dropdown").find(i.target).length) && (s.element.removeClass("uk-open"), e = !1) : (s.checkDimensions(), s.element.addClass("uk-open"), e = s.element, t(document).off("click.outer.dropdown"), setTimeout(function () {
        t(document).on("click.outer.dropdown", function (i) {
          !e || e[0] != s.element[0] || !t(i.target).is("a") && s.element.find(".uk-dropdown").find(i.target).length || (e.removeClass("uk-open"), t(document).off("click.outer.dropdown"))
        })
      }, 10))
    }) : this.element.on("mouseenter", function () {
      s.remainIdle && clearTimeout(s.remainIdle), e && e[0] != s.element[0] && e.removeClass("uk-open"), s.checkDimensions(), s.element.addClass("uk-open"), e = s.element
    }).on("mouseleave", function () {
      s.remainIdle = setTimeout(function () {
        s.element.removeClass("uk-open"), s.remainIdle = !1, e && e[0] == s.element[0] && (e = !1)
      }, s.options.remaintime)
    })
  };
  t.extend(n.prototype, {
    remainIdle: !1,
    options: {mode: "hover", remaintime: 800, justify: !1, boundary: t(window)},
    checkDimensions: function () {
      if (this.dropdown.length) {
        var i = this.dropdown.css("margin-" + t.UIkit.langdirection, "").css("min-width", ""), e = i.show().offset(),
          n = i.outerWidth(), s = this.boundary.width(), o = this.boundary.offset() ? this.boundary.offset().left : 0;
        if (this.centered && (i.css("margin-" + t.UIkit.langdirection, -1 * (parseFloat(n) / 2 - i.parent().width() / 2)), e = i.offset(), (n + e.left > s || 0 > e.left) && (i.css("margin-" + t.UIkit.langdirection, ""), e = i.offset())), this.justified && this.justified.length) {
          ...
          if (i.css("min-width", a), "right" == t.UIkit.langdirection) {
            var r = s - (this.justified.offset().left + a), l = s - (i.offset().left + i.outerWidth());
            i.css("margin-right", r - l)
          } else i.css("margin-left", this.justified.offset().left - e.left);
          e = i.offset()
        }
        n + (e.left - o) > s && (i.addClass("uk-dropdown-flip"), e = i.offset()), 0 > e.left && i.addClass("uk-dropdown-stack"), i.css("display", "")
      }
    }
  }), i.dropdown = n, t(document).on("mouseenter.dropdown.uikit", "[data-uk-dropdown]", function () {
    var e = t(this);
  ...
  "use strict";
  var e = t(window), n = "resize orientationchange", s = function (s, o) {
    var a = this;
    this.options = t.extend({}, this.options, o), this.element = t(s), this.columns = this.element.children(), this.elements = this.options.target ? this.element.find(this.options.target) : this.columns, this.columns.length && e.on(n, function () {
      var n = function () {
        a.match()
      };
      return t(function () {
  ...
  t.extend(s.prototype, {
    options: {target: !1}, match: function () {
      this.revert();
      ...
      if (i.length) {
        ...
        if (!e)return this.elements.each(function () {
          ...
          var e = t(this), o = "border-box" == e.css("box-sizing") ? "outerHeight" : "height", a = s.columns.eq(i),
            r = e.height() + (n - a[o]());
  ...
  var o = function (s) {
    var o = this;
    this.element = t(s), this.columns = this.element.children(), this.columns.length && e.on(n, function () {
      var n = function () {
        o.process()
      };
      return t(function () {
  ...
  t.extend(o.prototype, {
    process: function () {
      this.revert();
      var i = !1, e = this.columns.filter(":visible:first"), n = e.length ? e.offset().top : !1;
      ...
      return this.columns.removeClass("uk-grid-margin"), this
    }
  }), i["grid-match"] = s, i["grid-margin"] = o, t(function () {
    t("[data-uk-grid-match],[data-uk-grid-margin]").each(function () {
      var e = t(this);
      e.is("[data-uk-grid-match]") && !e.data("grid-match") && e.data("grid-match", new s(e, i.Utils.options(e.data("uk-grid-match")))), e.is("[data-uk-grid-margin]") && !e.data("grid-margin") && e.data("grid-margin", new o(e, i.Utils.options(e.data("uk-grid-margin"))))
    })
  })
}(jQuery, jQuery.UIkit), function (t, i, e) {
  "use strict";
  var n = !1, s = t("html"), o = function (e, s) {
    var o = this;
    this.element = t(e), this.options = t.extend({
      keyboard: !0,
      show: !1,
      bgclose: !0
    }, s), this.transition = i.support.transition, this.dialog = this.element.find(".uk-modal-dialog"), this.element.on("click", ".uk-modal-close", function (t) {
      t.preventDefault(), o.hide()
    }).on("click", function (i) {
      var e = t(i.target);
      e[0] == o.element[0] && o.options.bgclose && o.hide()
    }), this.options.keyboard && t(document).on("keyup.ui.modal.escape", function (t) {
  ...
  t.extend(o.prototype, {
    transition: !1, toggle: function () {
      ...
      this.element.hide().removeClass("uk-open"), s.removeClass("uk-modal-page"), n === this && (n = !1), this.element.trigger("uk.modal.hide")
    }, isActive: function () {
      return n == this
    }
  });
  var a = function (i, e) {
    var n = this, s = t(i);
    this.options = t.extend({target: s.is("a") ? s.attr("href") : !1}, e), this.element = s, this.modal = new o(this.options.target, e), s.on("click", function (t) {
      t.preventDefault(), n.show()
    }), t.each(["show", "hide", "isActive"], function (t, i) {
      n[i] = function () {
        return n.modal[i]()
      }
    })
  };
  a.Modal = o, i.modal = a, t(document).on("click.modal.uikit", "[data-uk-modal]", function () {
    var e = t(this);
...
}(jQuery, jQuery.UIkit, jQuery(window)), function (t, i) {
  "use strict";
  i.support.touch && t("html").addClass("uk-touch");
  var e, n = t(window), s = t(document), o = {
    show: function (i) {
      if (i = t(i), i.length) {
        var a = t("html"), r = i.find(".uk-offcanvas-bar:first"), l = r.hasClass("uk-offcanvas-bar-flip") ? -1 : 1,
          u = -1 == l && n.width() < window.innerWidth ? window.innerWidth - n.width() : 0;
        e = {x: window.scrollX, y: window.scrollY}, i.addClass("uk-active"), a.css({
          width: window.innerWidth,
          height: window.innerHeight
        }).addClass("uk-offcanvas-page"), a.css("margin-left", (r.outerWidth() - u) * l).width(), r.addClass("uk-offcanvas-bar-show").width(), i.off(".ukoffcanvas").on("click.ukoffcanvas swipeRight.ukoffcanvas swipeLeft.ukoffcanvas", function (i) {
          var e = t(i.target);
        ...
        }), s.on("keydown.offcanvas", function (t) {
          27 === t.keyCode && o.hide()
        })
      }
    }, hide: function (i) {
      var n = t("html"), o = t(".uk-offcanvas.uk-active"), a = o.find(".uk-offcanvas-bar:first");
      o.length && (t.UIkit.support.transition && !i ? (n.one(t.UIkit.support.transition.end, function () {
        n.removeClass("uk-offcanvas-page").attr("style", ""), o.removeClass("uk-active"), window.scrollTo(e.x, e.y)
    ...
    var n = this, s = t(i);
    this.options = t.extend({target: s.is("a") ? s.attr("href") : !1}, e), this.element = s, s.on("click", function (t) {
      t.preventDefault(), o.show(n.options.target)
    })
  };
  a.offcanvas = o, i.offcanvas = a, s.on("click.offcanvas.uikit", "[data-uk-offcanvas]", function (e) {
    e.preventDefault();
    var n = t(this);
  ...
  function e(i) {
    ...
    if (e.is(":visible")) n = e.outerHeight(); else {
      var s = {position: e.css("position"), visibility: e.css("visibility"), display: e.css("display")};
      n = e.css({position: "absolute", visibility: "hidden", display: "block"}).outerHeight(), e.css(s)
    }
    return n
  }
  ...
  var n = function (i, e) {
    var n = this;
    this.options = t.extend({}, this.options, e), this.element = t(i).on("click", this.options.toggler, function (i) {
      i.preventDefault();
      var e = t(this);
      n.open(e.parent()[0] == n.element[0] ? e : e.parent("li"))
    }), this.element.find(this.options.lists).each(function () {
      var i = t(this), e = i.parent(), s = e.hasClass("uk-active");
      i.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>'), e.data("list-container", i.parent()), s && n.open(e, !0)
    })
  };
  t.extend(n.prototype, {
    options: {toggler: ">li.uk-parent > a[href='#']", lists: ">li.uk-parent > ul", multiple: !1},
    open: function (i, n) {
      var s = this.element, o = t(i);
      ...
      }), o.toggleClass("uk-open"), o.data("list-container") && (n ? o.data("list-container").stop().height(o.hasClass("uk-open") ? "auto" : 0) : o.data("list-container").stop().animate({height: o.hasClass("uk-open") ? e(o.data("list-container").find("ul:first")) : 0}))
    }
  }), i.nav = n, t(function () {
  ...
  var e, n = function (i, e) {
    var n = this;
    this.options = t.extend({}, this.options, e), this.element = t(i).on({
      focus: function () {
        n.show()
      }, blur: function () {
        n.hide()
  ...
  t.extend(n.prototype, {
    tip: "", options: {
      offset: 5, pos: "top", src: function () {
        return this.attr("title")
      }
    }, show: function () {
      if (this.tip.length) {
        e.css({top: -2e3, visibility: "hidden"}).show(), e.html('<div class="uk-tooltip-inner">' + this.tip + "</div>");
        var i = t.extend({}, this.element.offset(), {
          ...
          r = {display: "none", visibility: "visible", top: i.top + i.height + s, left: i.left}, l = a.split("-");
        switch ("left" != l[0] && "right" != l[0] || "right" != t.UIkit.langdirection || (l[0] = "left" == l[0] ? "right" : "left"), l[0]) {
          case"bottom":
            t.extend(r, {top: i.top + i.height + o, left: i.left + i.width / 2 - n / 2});
            break;
          case"top":
            t.extend(r, {top: i.top - s - o, left: i.left + i.width / 2 - n / 2});
            break;
          case"left":
            t.extend(r, {top: i.top + i.height / 2 - s / 2, left: i.left - n - o});
            break;
          case"right":
            t.extend(r, {top: i.top + i.height / 2 - s / 2, left: i.left + i.width + o})
        }
        2 == l.length && (r.left = "left" == l[1] ? i.left : i.left + i.width - n), e.css(r).attr("class", "uk-tooltip uk-tooltip-" + a).show()
      }
    }, hide: function () {
  ...
  var e = function (i, e) {
    var n = this;
    if (this.options = t.extend({}, this.options, e), this.element = t(i).on("click", this.options.toggler, function (t) {
  ...
  t.extend(e.prototype, {
    options: {connect: !1, toggler: ">*"}, show: function (i) {
  ...
  var e = function (i, e) {
    var n = this;
    if (this.element = t(i), this.options = t.extend({connect: !1}, this.options, e), this.options.connect && (this.connect = t(this.options.connect)), window.location.hash) {
    ...
    var o = t('<li class="uk-tab-responsive uk-active"><a href="javascript:void(0);"></a></li>'), a = o.find("a:first"),
      r = t('<div class="uk-dropdown uk-dropdown-small"><ul class="uk-nav uk-nav-dropdown"></ul><div>'),
      l = r.find("ul");
    a.html(this.element.find("li.uk-active:first").find("a").text()), this.element.hasClass("uk-tab-bottom") && r.addClass("uk-dropdown-up"), this.element.hasClass("uk-tab-flip") && r.addClass("uk-dropdown-flip"), this.element.find("a").each(function (i) {
      var e = t(this).parent(),
        s = t('<li><a href="javascript:void(0);">' + e.text() + "</a></li>").on("click", function () {
    ...
    }), o.append(r).uk("dropdown", {mode: "click"}), this.element.append(o).data({
      dropdown: o.data("dropdown"),
      mobilecaption: a
    }).on("uk.switcher.show", function (t, i) {
      o.addClass("uk-active"), a.html(i.find("a").text())
    })
  };
  i.tab = e, t(function () {
  ...
  var e = function (i, e) {
    var n = this;
    this.options = t.extend({}, this.options, e), this.element = t(i), this.timer = null, this.value = null, this.input = this.element.find(".uk-search-field"), this.form = this.input.length ? t(this.input.get(0).form) : t(), this.input.attr("autocomplete", "off"), this.input.on({
      keydown: function (t) {
        if (n.form[n.input.val() ? "addClass" : "removeClass"](n.options.filledClass), t && t.which && !t.shiftKey)switch (t.which) {
          case 13:
            n.done(n.selected), t.preventDefault();
            break;
          case 38:
            n.pick("prev"), t.preventDefault();
            break;
          case 40:
            n.pick("next"), t.preventDefault();
            break;
          case 27:
          case 9:
            n.hide();
      ...
      n.form.removeClass("uk-open").removeClass("uk-loading").removeClass("uk-active"), n.value = null, n.input.focus()
    }), this.dropdown = t('<div class="uk-dropdown uk-dropdown-search"><ul class="uk-nav uk-nav-search"></ul></div>').appendTo(this.form).find(".uk-nav-search"), this.options.flipDropdown && this.dropdown.parent().addClass("uk-dropdown-flip")
  };
  t.extend(e.prototype, {
    options: {
      source: !1,
      ...
      this.form.addClass(this.options.loadingClass), this.options.source ? t.ajax(t.extend({
        ...
        dataType: "json",
        success: function (t) {
          t = e.options.onLoadedResults.apply(this, [t]), e.form.removeClass(e.options.loadingClass), e.suggest(t)
        }
      ...
      var t = this, i = this.value, e = {};
      return this.value = this.input.val(), this.value.length < this.options.minLength ? this.hide() : (this.value != i && (this.timer && window.clearTimeout(this.timer), this.timer = window.setTimeout(function () {
        e[t.options.param] = t.value, t.request({data: e})
      ...
      if (i) {
        var e = this, n = {
          mouseover: function () {
            ...
            i.preventDefault(), e.done(t(this).parent())
          }
        };
        i === !1 ? this.hide() : (this.selected = null, this.dropdown.empty(), this.options.msgResultsHeader && t("<li>").addClass(this.options.resultsHeaderClass + " " + this.options.skipClass).html(this.options.msgResultsHeader).appendTo(this.dropdown), i.results && i.results.length > 0 ? (t(i.results).each(function () {
          ...
          this.text && i.find("a").append("<div>" + this.text + "</div>"), e.dropdown.append(i)
  ...
  }), i.search = e, t(document).on("focus.search.uikit", "[data-uk-search]", function () {
    var n = t(this);
  ...
  var e = function (i, e) {
    ...
    }, e), this.element = t(i).on("click", function () {
      var i = (t(this.hash).length ? t(this.hash) : t("body")).offset().top, e = t(document).height(),
        s = t(window).height();
      return i + s > e && (i = i - s + 50), t("html,body").stop().animate({scrollTop: i}, n.options.duration, n.options.transition), !1
    })
  };
  i["smooth-scroll"] = e, t.easing.easeOutExpo || (t.easing.easeOutExpo = function (t, i, e, n, s) {
...
$(document).ready(function () {
  ...
  stickyMenu = function () {
    if ($(window).scrollTop() > 80 && $(window).width() > 960 && !window.mobilecheck()) {
      $("#goTop").show();
      $(".uk-navbar").css({padding: "5px 0"})
    } else if ($(window).width() > 960 && $(window).width() < 1219) {
      $("#goTop").hide();
      $(".uk-navbar").css({padding: "10px 0"})
    } else {
      if ($(window).width() > 959) {
        $("#goTop").hide();
        $(".uk-navbar").css({padding: "20px 0"})
      } else {
        $("#goTop").show();
        $(".uk-navbar").css({padding: "0"})
      }
    }
  };
  ...
  var rollStart = $("#sidebar .tm-ad"), rollSet = $("#sidebar .search,#sidebar .member");
  ...
  objWindow.scroll(function () {
    if (objWindow.scrollTop() > offset.top) {
      ...
      rollBox.show().stop().animate({top: 0, paddingTop: 70}, 400).css({"z-index": "999"})
    } else {
